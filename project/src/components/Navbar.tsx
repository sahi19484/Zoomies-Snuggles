...
import { Heart, Menu, X, User, LogOut, Settings, UserCircle, ChevronDown } from 'lucide-react';
...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    toast.success('You have been successfully logged out. Thank you for visiting Zoomies & Snuggles!');
  };
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-50 border border-primary-200 animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="px-4 py-3 border-b border-primary-100">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-semibold text-primary-800">{currentUser.name}</p>
                          <p className="text-sm text-primary-500 capitalize">{currentUser.userType}</p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="border-t border-primary-200 pt-3 mt-3">
                  <div className="px-3 py-3 bg-primary-50 rounded-lg mx-3 mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-primary-800">{currentUser.name}</p>
                        <p className="text-xs text-primary-500 capitalize">{currentUser.userType}</p>
                      </div>
                    </div>
                  </div>
                  <button
