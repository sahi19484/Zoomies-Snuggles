...
const Auth = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      // Registration with organization code validation
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-warm-50 to-secondary-50 py-8">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-3 border border-primary-200 rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 transition-all duration-200"
                        placeholder="e.g., University Road, Kalawad Road"
                      />
                    </div>
                  </div>

                  {(userType === 'foster' || userType === 'volunteer') && (
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 border border-primary-200 rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 resize-none transition-all duration-200"
            ...
            {isLogin && (
              <div className="mt-4 text-center">
                <button 
                  ...
                  className="text-secondary-500 hover:text-secondary-600 text-sm font-medium transition-colors"
                >
              ...
              <div className="mt-6 text-center">
                <p className="text-xs text-primary-500">
                  ...
                  <button 
                    ...
                    className="text-secondary-500 hover:text-secondary-600 underline transition-colors"
                  >
                    Terms of Service
                  </button>
                  {' '}and{' '}
        ...
        <div className="mt-8 text-center">
          <p className="text-primary-600 mb-4">Need help getting started?</p>
